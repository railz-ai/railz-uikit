...
export interface RailzButtonCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLRailzButtonElement;
}
export interface RailzInputTextCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLRailzInputTextElement;
}
declare global {
...
declare namespace LocalJSX {
    interface RailzButton {
        ...
        "label"?: string;
        "loading"?: boolean;
        "onButtonClick"?: (event: RailzButtonCustomEvent<any>) => void;
        "shape"?: string;
        "size"?: string;
        "target"?: string;
        "type"?: string;
    ...
    interface RailzInputText {
        ...
        "minContentLength"?: number;
        "minNumber"?: string;
        "onValueChange"?: (event: RailzInputTextCustomEvent<any>) => void;
        "pattern"?: string;
        "placeholder"?: string;
        "prefixIcon"?: string;
        "readonly"?: boolean;
